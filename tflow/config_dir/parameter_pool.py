class LossComb:
    STANDARD = {"box_2d": ([3., 3., 3.], "L1smooth"),
                "object": ([4., 2., 1.], "BoxObjectnessLoss", 1, 1),
                "category_2d": ([1., 1., 1.], "MajorCategoryLoss", "2d"),
                "category_3d": ([1., 1., 1.], "MajorCategoryLoss", "3d"),
                "box_3d": ([5., 5., 5.], "Box3DLoss"),
                "theta": ([1., 1., 1.], "ThetaLoss", 1.1, 1.5)}


class TrainingPlan:
    KITTI_SIMPLE = [
        ("kitti", 30, 0.001, LossComb.STANDARD, True),
        ("kitti", 20, 0.0001, LossComb.STANDARD, True),
        # ("kitti", 1, 0.0001, LossComb.STANDARD, True),
    ]
