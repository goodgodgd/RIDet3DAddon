...
class TrainingPlan:
    KITTI_SIMPLE = [
        ...
        ("kitti", 30, 0.0009, LossComb.STANDARD, True),
        ("kitti", 30, 0.0004, LossComb.STANDARD, True),

        ("kitti", 30, 0.00009, LossComb.STANDARD_SCALE, True),
        ("kitti", 30, 0.00004, LossComb.STANDARD_SCALE, True),

        ("kitti", 30, 0.000009, LossComb.STANDARD_SCALE, True),
        ("kitti", 30, 0.000004, LossComb.STANDARD_SCALE, True),
    ]
...
class TrainParams:
    ...
    def get_3d_pred_composition(cls, iou_aware, categorized=False):
        ...
        reg_composition = {"yx": 2, "hwl": 3, "theta": 1, "object": 1}
        if iou_aware:
            reg_composition["ioup"] = 1
        composition = {"reg": reg_composition, "cls": cls_composition}
