...
from RIDet3DAddon.torch.log.metric import count_true_positives
...
class ExhaustiveLog:
    def __init__(self, loss_names):
        ...
        self.num_anchors = cfg3d.ModelOutput.NUM_ANCHORS_PER_SCALE * len(cfg3d.ModelOutput.FEATURE_SCALES)
        self.num_categs = cfg3d.ModelOutput.PRED_MAIN_COMPOSITION["category"]
    ...
    def compute_sum_summary(self):
        sum_data = self.metric_data[cfg3d.Log.ExhaustiveLog.COLUMNS_TO_SUM]
        ...
        sum_data = self.ctgr_anchor_data[cfg3d.Log.ExhaustiveLog.COLUMNS_TO_SUM]
